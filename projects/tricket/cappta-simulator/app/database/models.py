...
# Reseller Table (Compatibilidade com API Oficial)
class ResellerDB(Base):
    __tablename__ = "resellers"
    
    reseller_id = Column(String, primary_key=True)
    document = Column(String(14), nullable=False, unique=True)  # CNPJ do reseller
    ...
    api_token = Column(String(100), nullable=False)  # Token para authenticação
    
    # Limits and Configuration
    daily_limit = Column(Integer, default=1000000)  # Limite diário em centavos
    monthly_limit = Column(Integer, default=10000000)  # Limite mensal em centavos
    
    # Metadata
    reseller_metadata = Column(JSON)
    ...
    # Relationships
    merchants = relationship("MerchantDB", back_populates="reseller")
