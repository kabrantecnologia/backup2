...
-- Habilita o pgcrypto para funções criptográficas (ex: geração de senhas seguras).
CREATE EXTENSION IF NOT EXISTS "pgcrypto";
COMMENT ON EXTENSION pgcrypto IS 'Extensão para funções de criptografia no PostgreSQL. Utilizada para geração de senhas seguras e operações de criptografia.';
